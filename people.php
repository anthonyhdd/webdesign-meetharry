...
<section class="s_pages" id="discover">
	<div class="inner">
		<h3>Recherche de géniaux Harry* <span class="h3_bubble">*on a trouvé 501 Harry(s)</span></h3>
		...
		<div class="inner_box">
			...
			<div class="zone_right">
				...
				<form id="search-form" class="form-horizontal" role="form">
				    ...
				    <input type="text" id="tagsSearchInput" name="tags" placeholder="Compétences dont tu as besoin" class="form-control" value="">
				    <br />
				    <input id="refresh-btn" type="submit" value="Search">
				    <a class="p_button blue" href="/people?people-for-my-project=1"><span class="glyphicon glyphicon-search"></span> Recherche des Harrys pour ton harryco</a>
				</form>
